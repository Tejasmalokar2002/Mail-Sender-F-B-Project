...
public class UserController {
    ...
    @DeleteMapping("/delete-mail-credentials/{mailCredentialsId}")
    public ResponseEntity<Map<String, Object>> deleteCredential(@PathVariable long mailCredentialsId) {
        Map<String, Object> map = this.userMassMailService.deleteCredentials(mailCredentialsId);
        return ResponseEntity.ok().body(map);
    }
